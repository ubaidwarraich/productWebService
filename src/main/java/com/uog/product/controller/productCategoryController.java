...
import com.uog.systemsetting.model.Lookup;
...
public class productCategoryController {
	...
	public String get(@RequestHeader(value = "Authorization") String headToken) throws JsonProcessingException {
		...
		APIRequestDataLog apiRequest = tableDataLogs.apiRequestDataLog("GET", databaseTableID, requestUser, "/productcategory", null,
				workstation);
	...
	public String getOne(@RequestHeader(value = "Authorization") String headToken,@PathVariable Long id) throws JsonProcessingException {
		ObjectMapper mapper = new ObjectMapper();
		...
		DatabaseTables databaseTableID = databasetablesrepository.findOne(ProductCategory.getDatabaseTableID());
		APIRequestDataLog apiRequest = tableDataLogs.apiRequestDataLog("GET", databaseTableID, requestUser, "/productcategory"+id, null,
				workstation);
	...
	public String getAll(@RequestHeader(value = "Authorization") String headToken) throws JsonProcessingException {
		...
		DatabaseTables databaseTableID = databasetablesrepository.findOne(ProductCategory.getDatabaseTableID());
		APIRequestDataLog apiRequest = tableDataLogs.apiRequestDataLog("GET", databaseTableID, requestUser, "/productcategory/all", null,
				workstation);
